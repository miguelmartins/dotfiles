    ...
    { "WhoIsSethDaniel/mason-tool-installer.nvim" },
    {
        ...
        config = function()
            ...
            local servers = {
                ...
                -- gopls = {},
                pyright = {
                    -- tell pyright to stop registering its own OrganizeImports action
                    settings = {
                        pyright = {
                            disableOrganizeImports = true,
                        },
                        -- if you really do want Ruff to be your only linter,
                        -- you can also turn off all of Pyright’s analysis diagnostics:
                        python = {
                            analysis = {
                                ignore = { "*" },
                            },
